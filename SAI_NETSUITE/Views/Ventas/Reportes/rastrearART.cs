...
{
    public partial class rastrearART : UserControl
    {
        public rastrearART()
        {
            InitializeComponent();
        ...
        public void cargainfo(string cliente)
        {
            ...
            {
                string query = "EXEC Indarneg.DBO.sp_rastrearArticulosCliente '" + cliente + "'";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            gridControl1.ExportToXlsx(carpeta + "\\rastrer.xlsx");
            Process pdfexport = new Process();
            pdfexport.StartInfo.FileName = "EXCEL.exe";
            pdfexport.StartInfo.Arguments = carpeta + "\\rastrer.xlsx";
            pdfexport.Start();
        }
    }
}
