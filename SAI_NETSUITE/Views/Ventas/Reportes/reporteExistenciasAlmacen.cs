...
{
    public partial class reporteExistenciasAlmacen : UserControl
    {
        public reporteExistenciasAlmacen()
        {
            InitializeComponent();
        }
        ...
        public void cargainfo(string cliente)
        {
            ...
            {
                string query = "EXEC Indarneg.DBO.sp_reporteExistenciasAlmacen " + cliente + "";
